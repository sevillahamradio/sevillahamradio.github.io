...
$email_mesuser .= "<tr align='center'>	
<td style='padding-bottom: 10px;'><a href='mailto:sevillahamradio@gmail.com' target='_blank' title='sevillahamradio'>SEVILLAHAMRADIO@GMAIL.COM </a><span></td></tr>";		
	
$email_mesuser .= "</table>";
$email_mesuser .= "</body></html>";	
// FIN EMAIL --------- CONTENIDO	
	// envio email
$email_envio = "diodin68@hotmail.com";

if(mail($email_envio, $asunto, $email_message, $cabeceras)){
...
echo "<p><font color=#D80003> <center> ** EMAIL NO ENVIADO **<br />**DETECTADO ROBOT**<br /> </center></p>"; 
	echo "<p><font color=#fff12b> <center> VUELVA AL FORMULARIO DE REGISTRO <br />RELLENE LOS CAMPOS UNO POR UNO<br /> EVITANDO EL AUTOCOMPLETAR DEL NAVEGADOR.<br />
